  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
      ...
      <Field label="Phone Number:" required>
        <TextInput value={data.phone} onChange={(v) => update({ phone: v })} demoKey="phone" />
      </Field>

      <Field label="Email Address:" required>
        <TextInput value={data.email} onChange={(v) => update({ email: v })} type="email" demoKey="email" />
      </Field>
      ...
      <Field label="Street Address:" required>
        <TextInput value={data.streetAddress} onChange={(v) => update({ streetAddress: v })} demoKey="streetAddress" />
      </Field>
      ...
      <Field label="City:" required>
        <TextInput value={data.city} onChange={(v) => update({ city: v })} demoKey="city" />
      </Field>
      ...
      <Field label="Zip Code:" required>
        <TextInput value={data.zip} onChange={(v) => update({ zip: v })} demoKey="zip" />
      </Field>
