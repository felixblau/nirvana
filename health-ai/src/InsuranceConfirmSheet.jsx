      ...
      <div className="sheet insurance-confirm-sheet">
        ...
        <div className="ic-card">
          ...
          <ul className="ic-details">
            <li>
              <svg className="ic-icon" viewBox="0 0 24 24" fill="none" stroke="#2c1f45" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <li>
              ...
              <span className="ic-payer-line">
                ...
                <img className="ic-aetna" src={`${base}assets/aetna-logo.jpg`} alt="Aetna" />
