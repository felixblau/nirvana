...
import {
  HamburgerIcon, GeminiEditIcon, MicIcon, HeadphonesIcon, ChevronRightSmall,
  SignalIcon, WifiIcon, BatteryIcon, PlusIcon,
} from './Icons'
...
function AiMessage({ children }) {
  return <div className="msg-ai">{children}</div>
}
    ...
    >
      ...
      <div className="nav-bar">
        ...
        <div className="nav-bar-center">
          <span className="nav-bar-title-main">ChatPCP</span>
          <span className="nav-bar-title-version">4.6</span>
          <span className="nav-bar-title-chev"><ChevronRightSmall /></span>
        </div>
      ...
      <div className="input-bar">
        ...
        <div className="input-field-pill">
          <span className="input-placeholder">Ask ChatPCP</span>
