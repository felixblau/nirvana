...
const STROKE = new Set(["fa-chevron-right","fa-chevron-down","fa-clock","fa-signal","fa-hashtag","fa-cake-candles","fa-bell-slash","fa-person-walking","fa-stethoscope","fa-calendar","fa-wallet","fa-circle-info"]);
