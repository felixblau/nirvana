...
function SiteHeader() {
  return (
    ...
    >
      <img
        src="/lifestance/brand/lifestance-logo.png"
  ...
  return (
    <section
      style={{
        ...
        overflow: 'hidden',
        backgroundImage:
          'linear-gradient(rgba(0, 0, 0, 0.55), rgba(0, 0, 0, 0.55)), url(/lifestance/brand/hero.jpg)',
    ...
    >
      ...
      >
        <HeroButton onClick={onNext}>Get Matched With A Provider</HeroButton>
